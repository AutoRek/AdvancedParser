...
namespace ApiSoftware.Library35.Parsing
{
	...
	/// </summary>
	/// <remarks>
	/// The decimal rule parses a single decimal value. 
	/// Whitespace before the decimal value is ignored.
	/// </remarks>
	[XmlRoot("Decimal")]
	public sealed class DecimalRule : RuleBase
	{
		...
		/// <returns>Object containing the decimal value of the node (or null).</returns>

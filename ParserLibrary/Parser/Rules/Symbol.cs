...
namespace ApiSoftware.Library35.Parsing
{
	...
	/// </remarks>
	public sealed class Symbol : RuleBase
	{
		...
		public Symbol()
		{
			ErrorTemplate = "Error at line {0}, position {1}: Expected '{3}' but found '{2}'";
		}
		...
		internal override string FormattedOutput(OutputNode node)
		{
			...
			return string.Format(CultureInfo.InvariantCulture, Template, GetValue(node));
		}

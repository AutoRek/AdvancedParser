...
namespace ParserLibraryTests
{
	...
	///</summary>
	[TestClass()]
	public class StringTest : RuleTestsBaseClass
	{
		...
		{
			var rule = CreateTestRule();
			Assert.AreEqual("TestRule:ApiSoftware.Library35.Parsing.StringRule", rule.ToString());
		}
		...
		private StringRule CreateTestRule()
		{
			var rule = new StringRule();
			rule.Name = "TestRule";
			rule.Template = "[{0}]";
